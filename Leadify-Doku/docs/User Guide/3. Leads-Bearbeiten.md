...
![Neue Nachricht Batch](../assets/images/Neue_Nachricht_Batch.png)
...
![Lead Stati](../assets/images/Lead_Stati.png)
...
![Lead Detail Ansicht](../assets/images/Lead-Detail-Ansicht.png)
...
- Eine Anbindung an ein externes System (z. B. CRM oder Kundenstammdatenbank) ist über eine API-Schnittstelle 
  vorgesehen. Dabei können relevante Kunden- und Kontaktdaten automatisiert übertragen und weiterverarbeitet werden.
...
- Über eine API-Schnittstelle kann der Lead an ein externes Angebots- oder ERP-System übergeben werden. Dabei werden  
  relevante Kunden- und Bedarfsdaten automatisiert übertragen.
- Der Lead bleibt dokumentiert und abgeschlossen im Angebotsstatus.

![Angebot erstellen](../assets/images/Angebot_erstellen.png)
...
![Lead Ablehnen](../assets/images/Lead_ablehnen.png)
...
![Lead weiterleiten](../assets/images/Lead_weiterleiten.png)
...
![Lead erledigen](../assets/images/Lead_erledigen.png)
