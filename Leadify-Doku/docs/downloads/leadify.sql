...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 23. Feb 2026 um 08:32
...
INSERT INTO `benutzer` (`benutzer_id`, `is_approved`, `vorname`, `nachname`, `email`, `passwort_hash`, `rolle_id`, `anrede`) VALUES
(1, 1, 'admin', 'admin', 'admin@leadify.com', '$2b$12$6F8YtMxxrCCm5zOFZxgmL.oaEXpp1hkEkGTIwHo4oT1DGSWV2MdlK', 0, 1),
(2, 0, 'admin', 'konto', 'admin2@leadify.com', '', 0, 1),
(3, 1, 'Max', 'Mustermann', 'ausendienst@leadify.com', '$2b$12$6jayLjkS195f.cjMFG5nGuJLFkocSvzUWomCCTMqgiMVPa2btyHGK', 1, 1),
(4, 0, 'Martin', 'Musterdienst', 'ausendienst2@leadify.com', '', 1, 1),
(5, 1, 'Michael', 'Innendienst', 'innendienst@leadify.com', '$2b$12$yHZBSYaGCxMjBMUG9zr2MeNjvdwaZPSO.KCK6dgMg/I1pNne096b.', 2, 1),
(6, 0, 'Mareike', 'Musterfrau', 'innendienst2@leadify.com', '', 2, 2),
(7, 1, 'John', 'Doe', 'auswertung@leadify.com', '$2b$12$idmS7Ux4YCivdZLvCCpcFOFSditDoh/n591bdUG1JP4zUSQz7.j.6', 4, 1);
...
CREATE TABLE `lead_aktionen` (
  ...
  `lead_id` int(11) NOT NULL,
  `benutzer_id` int(11) NOT NULL,
  `aktion_typ` enum('angenommen','abgelehnt','zugewiesen','erledigt','Angebot erstellt','Zum Löschen vorgemerkt','lead_angesehen') NOT NULL,
...
--
ALTER TABLE `sessions`
  ADD CONSTRAINT `sessions_ibfk_1` FOREIGN KEY (`benutzer_id`) REFERENCES `benutzer` (`benutzer_id`) ON DELETE CASCADE;
COMMIT;
